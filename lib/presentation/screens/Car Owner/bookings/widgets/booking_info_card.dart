    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Row(
            children: [
              SvgPicture.asset('assets/svg/user.svg', height: 14, width: 14, color: Colors.grey[600]),
              const SizedBox(width: 6),
              Expanded(
                child: Text(
          ...
          Row(
            children: [
              ...
              if (rent.customerPhone != null) ...[
                SvgPicture.asset('assets/svg/phone.svg', height: 12, width: 12, color: Colors.grey[600]),
              ...
              if (rent.deliveryAddress?.address != null) ...[
                Container(
                  ...
                  child: Row(
                    mainAxisSize: MainAxisSize.min,
                    children: [
                      SvgPicture.asset('assets/svg/location.svg', height: 10, width: 10, color: Colors.orange),
          ...
          if (rent.deliveryAddress?.address != null) ...[
            ...
            Row(
              children: [
                SvgPicture.asset('assets/svg/location.svg', height: 12, width: 12, color: Colors.grey[600]),
                const SizedBox(width: 4),
                Expanded(
                  child: Text(
